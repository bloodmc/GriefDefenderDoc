...
『情境』 常被 GD 用于限定各类行为的作用情境，要了解什么是情境，请参考 https://luckperms.net/wiki/Context

常见的情境使用方法有：
1. 限定 『标签』 的作用方式
2. 限定 『选项』 的影响范围（比如限制某类型领地的圈地上限
3. 限定 『权限』
4. ...

GD 根据需要对 『情境』 进行了拓展，以便于你能客制化 『标签』 的使用体验，**下边的列表可能不是最新的，看个乐呵就好**
