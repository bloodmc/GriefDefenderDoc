...
## Configuration  
Default values can be changed in [`options.yml`](/wiki/basic/Options.html)  
...
Note: If you get a message stating the option is not enabled, enable it under `option-control` in [`options.yml`](/wiki/basic/Options.html).
