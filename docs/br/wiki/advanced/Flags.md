...
> ** Nota: Começando com as versões MC 1.14+, GD se integra ao sistema de tags da Vanilla.É altamente recomendável usar o sistema de tags de baunilha.Consulte https://minecraft.wiki/w/Tag#Usage para obter mais informações e https://minecraft.wiki/w/Tutorials/Creating_a_data_pack para obter mais informações.
