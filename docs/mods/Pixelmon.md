...
## FITFC's Optimization for PixelMon

::: info Requires merge with Optimization for Minecraft
These optimizations need to be merged with the optimizations for Minecraft:*, I recommend using optimization [FITFC's Optimization for Minecraft](/wiki/advanced/Optimizations.html#fitfc-s-optimization)
:::

<details>
  <summary>FITFC's Blacklist-PixelMon</summary>
